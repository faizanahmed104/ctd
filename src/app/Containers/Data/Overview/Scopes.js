      ...
      data: [
        {
          ...
          func: () => {
            setActiveHeader(2);
            router.push("/data/ipcc/stationary-combustion");
          },
        },
        {
          ...
          func: () => {
            setActiveHeader(2);
            router.push("/data/ipcc/mobile-combustion");
          },
        },
        {
          icon: (
          ...
          func: () => {
            setActiveHeader(2);
            router.push("/data/ipcc/fugitive-emissions");
          },
        },
      ],
    },
      ...
      data: [
        {
          ...
          func: () => {
            setActiveHeader(2);
            router.push("/data/ipcc/purchased-electricity");
          },
        },
        {
          ...
          func: () => {
            setActiveHeader(2);
            router.push("/data/ipcc/purchased-heat");
          },
        },
      ],
    },
