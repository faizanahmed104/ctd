...
import { AddConsumptionForm } from "./AddPurchasedElectricityForm";
import { TemplatePart } from "./TemplatePart";

function AddPurchasedElectricity({ headerTitle }) {
      ...
      <div className="rounded-lg border-2 border-[#C4C4C4] px-6 pt-6 pb-[18px] mb-[46px]">
        ...
        >
          <span className="text-base text-black font-poppins">
            To apply this calculation method, you need data on the amount of
            electricity purchased by your organization. Purchased electricity
            excludes emissions from electricity consumed in leased facilities
            not controlled by the company, third-party electricity not directly
            purchased by the company, and electricity associated with renewable
            energy certificates (RECs) or green power programs. If you have
            questions, contact our consultant team at Carbon Track to guide you
...
export default AddPurchasedElectricity;
