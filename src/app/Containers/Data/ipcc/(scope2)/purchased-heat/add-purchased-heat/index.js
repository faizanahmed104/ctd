...
import { AddPurchasedHeatForm } from "./AddPurchasedHeatForm";
import { TemplatePart } from "./TemplatePart";

function AddPurchasedHeat({ headerTitle }) {
    ...
    <div>
      ...
      <div className="rounded-lg border-2 border-[#C4C4C4] px-6 pt-6 pb-[18px] mb-[46px]">
        ...
        >
          ...
          <AddPurchasedHeatForm text={"Fuel Consumption Method"} />
        </div>
      </div>
      <div className="rounded-lg border-2 border-[#C4C4C4] px-6 pt-6 pb-[18px] mb-[46px]">
        <div className="flex flex-row items-center justify-between mb-7">
...
export default AddPurchasedHeat;
